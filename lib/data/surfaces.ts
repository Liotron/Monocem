...
export const surfaces: Surface[] = [
  {
    ...
    benefits: ["Zero grout lines for seamless appearance", "Compatible with underfloor heating", "Waterproof and highly durable", "Available in 100+ custom colours", "Applied over existing surfaces — minimal disruption", "Easy to clean and maintain"],
  ...
  },
  {
    ...
    benefits: ["100% waterproof system", "No grout lines — hygienic and easy to clean", "Continuous floor-to-ceiling finish possible", "Warm underfoot", "Available in all 100+ MONOCEM colours", "Suitable for shower enclosures and wet rooms"],
  ...
  },
  {
    ...
    benefits: ["Seamless integration across floors and walls", "Heat-resistant surface", "Easy to clean — no grout to discolour", "Compatible with all kitchen designs", "Hardwearing under daily use", "Available in all 100+ MONOCEM colours"],
    ...
    features: [
      ...
      { title: "100+ Colour Options", desc: "Matched across every kitchen surface" },
  ...
  },
  {
    ...
    benefits: ["Continuous seamless finish from floor to stair", "Can coat existing wood or concrete stairs", "Anti-slip sealer options available", "Durable under heavy foot traffic", "Matches any microcement floor for cohesive look", "Available in all 100+ MONOCEM colours"],
    ...
    features: [
      ...
      { title: "Matches Any Floor", desc: "Available in all 100+ MONOCEM colours" },
