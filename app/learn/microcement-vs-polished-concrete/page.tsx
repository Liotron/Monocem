...
const data = {
  ...
  sidebarLinks: [
    ...
    { label: "Microcement Cost UK", description: "Pricing Guide", href: "/learn/microcement-cost-uk" },
    { label: "Get a Free Quote", description: "Compare for Your Project", href: "/get-a-quote" },
  ],
};
