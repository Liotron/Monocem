...
const data = {
  ...
  sidebarLinks: [
    { label: "Get a Free Quote", description: "Detailed Pricing for Your Project", href: "/get-a-quote" },
    { label: "View Our Systems", description: "Installation Services", href: "/installation" },
    { label: "Open a Trade Account", description: "Bulk & Supply-Only Pricing", href: "/trade" },
  ],
};
