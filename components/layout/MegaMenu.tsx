    ...
    >
      ...
      <div className="relative flex-1 overflow-hidden">
        ...
        >
          ...
          <Link href="/get-a-quote" onClick={() => onNavigate("/get-a-quote")} className="block w-full min-h-[60px] px-8 bg-charcoal text-white font-body text-[0.7rem] font-medium tracking-[0.18em] uppercase text-center flex items-center justify-center hover:bg-gold transition-colors duration-300">
            Get a Quote
          </Link>
        </div>
